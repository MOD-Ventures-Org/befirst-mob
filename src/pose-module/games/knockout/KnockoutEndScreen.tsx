...
export interface KnockoutEndScreenProps {
	score: number;
...
/** Push Knockout end screen: damage, bosses beaten, best combo, reps. */
export const KnockoutEndScreen = ({
	score,
	bossesDefeated,
	maxCombo,
	repCount,
	...
	return (
		<View style={styles.root}>
			<View style={styles.content}>
				<Text style={styles.emoji}>{knockedOut ? '💫' : '🥊'}</Text>
				<Text style={styles.title}>
					{t(
						knockedOut
							? 'settings:aiTrainer.games.knockout.koTitle'
							: 'settings:aiTrainer.games.knockout.endTitle',
					)}
				</Text>
				<View style={styles.statsCard}>
					<Text style={styles.scoreText}>
						{t('settings:aiTrainer.games.knockout.damage', { score })}
					</Text>
					<Text style={styles.detailText}>
						{t('settings:aiTrainer.games.knockout.bossesDefeated', { count: bossesDefeated })}
					</Text>
					<Text style={styles.detailText}>
						{t('settings:aiTrainer.games.knockout.maxCombo', { count: maxCombo })}
					</Text>
					<Text style={styles.detailText}>
